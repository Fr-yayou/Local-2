...
//FOUND THE PRODUCT BASE ON CATEGORY
    ...
    for (let key in req.body.filters) {
        if (req.body.filters[key].length > 0) {
            if (key === "price") {
                ...
                // lte - less than
                findArgs[key] = {
                    $gte: req.body.filters[key][0], //greater
                    $lte: req.body.filters[key][1]  //less
                };
            } else {
